...
export default function DoorDouble({ size = 80, color = '#1565C0' }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 80 80">
      ...
      <Path d="M 14 14 A 26 26 0 0 1 40 14" fill="none" stroke={color} strokeWidth={1.5} strokeDasharray="3,3" />
      {/* Anta dx */}
      <Rect x={46} y={10} width={24} height={60} fill="none" stroke={color} strokeWidth={1.5} />
      <Line x1={66} y1={14} x2={66} y2={66} stroke={color} strokeWidth={2} />
      <Path d="M 66 14 A 26 26 0 0 0 40 14" fill="none" stroke={color} strokeWidth={1.5} strokeDasharray="3,3" />
      {/* Maniglie */}
